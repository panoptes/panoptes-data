...
def frame_document(unit_id=UNIT_ID, camera_id=CAMERA_ID, sequence_time=SEQUENCE_TIME,
                   image_time=IMAGE_TIMES[0], *, mount_ra=83.8221, mount_dec=-5.39111,
                   exptime=120.0, status='MATCHED', field_name='M42',
