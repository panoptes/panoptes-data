...
class TestIndexWithoutCoordinates:
    ...
    def test_such_a_sequence_matches_no_cone(self, tmp_path, monkeypatch):
        ...
        results = search_observations(ra=83.8, dec=-5.4, radius=180.0,
...
class TestSearchObservations:
    ...
    def test_exptime_is_the_mean_over_frames(self):
        results = search_observations(
            coords=SkyCoord(ra=10.0, dec=20.0, unit='deg'), radius=5.0,
    ...
    def test_the_source_table_is_not_mutated(self):
        ...
        search_observations(coords=SkyCoord(ra=10.0, dec=20.0, unit='deg'), radius=1.0,
                            source=source, start_date='2023-01-01', end_date='2023-12-31')
    ...
    def test_filters_by_unit_id(self):
        results = search_observations(
            coords=SkyCoord(ra=50.0, dec=5.0, unit='deg'), radius=180.0,
            unit_id='PAN002', source=observations_table(),
    ...
    def test_a_cone_across_zero_hours_is_found(self):
        ...
        results = search_observations(
            coords=SkyCoord(ra=0.0, dec=20.0, unit='deg'), radius=1.0,
            source=source, start_date='2023-01-01', end_date='2023-12-31',
        )
    ...
    def test_a_sequence_that_drifted_into_the_cone_is_found(self):
        ...
        source = observations_table(mount_ra=[12.0, 10.5, 100.0],
                                    mount_ra_drift=[1.5, 0.0, 0.0])

        results = search_observations(
            coords=SkyCoord(ra=10.0, dec=20.0, unit='deg'), radius=1.0, min_num_frames=3,
            source=source, start_date='2023-01-01', end_date='2023-12-31',
        )
    ...
    def test_unknown_drift_does_not_widen_the_cone_to_everything(self):
        ...
        results = search_observations(
            coords=SkyCoord(ra=10.0, dec=20.0, unit='deg'), radius=1.0,
            source=source, start_date='2023-01-01', end_date='2023-12-31',
        )
    ...
    def test_dates_default_to_this_year_so_far(self):
        ...
        source = observations_table(
            sequence_time=[f'{pd.Timestamp.now(tz="UTC").year}-01-02T00:00:00+00:00',
                           '2023-01-02T00:00:00+00:00',
                           '2023-06-01T00:00:00+00:00']
        )
    ...
    def test_by_name_resolves_coordinates(self, monkeypatch):
        monkeypatch.setattr(
            search_mod.SkyCoord, 'from_name',
            classmethod(lambda cls, name: SkyCoord(ra=10.0, dec=20.0, unit='deg')),
        )

        results = search_observations(
            by_name='M42', radius=1.0, source=observations_table(),
            start_date='2023-01-01', end_date='2023-12-31',
        )
    ...
    def test_an_empty_result_is_a_table_not_an_error(self):
        results = search_observations(
            coords=SkyCoord(ra=200.0, dec=70.0, unit='deg'), radius=1.0,
            source=observations_table(), start_date='2023-01-01', end_date='2023-12-31',
        )
    ...
    def test_ra_and_dec_stand_in_for_coords(self):
        results = search_observations(
            ra=10.0, dec=20.0, radius=1.0, source=observations_table(),
            start_date='2023-01-01', end_date='2023-12-31',
        )
...
class TestEndToEnd:
    def test_a_search_result_feeds_straight_into_observation_info(self, tmp_path, monkeypatch):
        ...
        results = search_observations(
            ra=83.5, dec=-5.39111, radius=1.0,
            start_date='2018-01-01', end_date='2018-12-31',
        )
