...
`panoptes-data` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/panoptes-data
[issue tracker]: https://github.com/<USERNAME>/panoptes-data/issues
